...
-- ----------------------------
CREATE UNIQUE INDEX IF NOT EXISTS "uk_configinfoaggr_datagrouptenantdatum" ON "config_info_aggr" USING btree ("data_id","group_id","tenant_id","datum_id");
...
-- ----------------------------
CREATE UNIQUE INDEX IF NOT EXISTS "uk_configinfobeta_datagrouptenant" ON "config_info_beta" USING btree ("data_id","group_id","tenant_id");
...
-- ----------------------------
CREATE UNIQUE INDEX IF NOT EXISTS "uk_configinfotag_datagrouptenanttag" ON "config_info_tag" USING btree ("data_id","group_id","tenant_id","tag_id");
...
-- ----------------------------
CREATE INDEX IF NOT EXISTS "idx_tenant_id" ON "config_tags_relation" USING btree (
  "tenant_id"
);
CREATE UNIQUE INDEX IF NOT EXISTS "uk_configtagrelation_configidtag" ON "config_tags_relation" USING btree (
  "id",
  "tag_name",
  "tag_type"
);
...
-- ----------------------------
CREATE UNIQUE INDEX IF NOT EXISTS "uk_group_id" ON "group_capacity" USING btree (
  "group_id"
);
...
-- ----------------------------
CREATE INDEX IF NOT EXISTS "idx_did" ON "his_config_info" USING btree (
  "data_id"
);
CREATE INDEX IF NOT EXISTS "idx_gmt_create" ON "his_config_info" USING btree (
  "gmt_create"
);
CREATE INDEX IF NOT EXISTS "idx_gmt_modified" ON "his_config_info" USING btree (
  "gmt_modified"
);
...
-- ----------------------------
CREATE UNIQUE INDEX IF NOT EXISTS "uk_role_permission" ON "permissions" USING btree (
  "role",
  "resource",
  "action"
);
...
-- ----------------------------
CREATE UNIQUE INDEX IF NOT EXISTS "uk_username_role" ON "roles" USING btree (
  "username",
  "role"
);
...
-- ----------------------------
CREATE UNIQUE INDEX IF NOT EXISTS "uk_tenant_id" ON "tenant_capacity" USING btree (
  "tenant_id"
);
...
-- ----------------------------
CREATE UNIQUE INDEX IF NOT EXISTS "uk_tenant_info_kptenantid" ON "tenant_info" USING btree (
  "kp",
  "tenant_id"
);
